...
\todo[inline]{write about Augmented reality, milgram continuum}. 

\subsection{Mixed Reality Displays}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.75]{opticalseethrough}
	\caption{Schematic diagram of the power and control network of a typical offshore supply vessel}
...
Video see-through combines closed-view HMD with head-mounted video camera views. Chroma-keying technique composes computer graphics in a specific-colored background - which can be replaced with real video, creating the effect of superimposing virtual object on real world. Problem is this does not use depth information.
\begin{figure}
	\centering
	\includegraphics[scale=0.75]{videoseethrough}
	\caption{videoseethrough}
...
\begin{figure}
	\centering
	\includegraphics[scale=.5]{monitorseethrough}
	\caption{Schematic diagram of the power and control network of a typical offshore supply vessel}
	\label{fig:opticalseethrough}
\end{figure}

\subsubsection{Photorealism}
\todo[inline]{Describe photorealism. Compare MR display categories}
\begin{table}[h]
\centering
...
\begin{figure}
	\centering
	\includegraphics[scale=0.40]{osvbridgelayout}
	\caption{Layout of the bridge room of a typical offshore supply vessel}
	\label{fig:videoseethrough}
\end{figure}
